...
clong N1 = 624;
clong M = 397;
culong MATRIX_A = 0x9908b0df;   /* constant vector a */
culong UPPER_MASK = 0x80000000; /* most significant w-r bits */
culong LOWER_MASK = 0x7fffffff; /* least significant r bits */

/* Tempering parameters */
culong TEMPERING_MASK_B = 0x9d2c5680;
culong TEMPERING_MASK_C = 0xefc60000;
